...
| 层 | 技术 | 职责 |
|---|---|---|
| 桌面壳 | Tauri 2 (Rust) | 窗口、系统托盘、sidecar 管理 |
| 界面 | Vue 3 + Vite | 交互、主题、任务可视化 |
| 通信 | HTTP REST + WebSocket | 指令下发、实时进度推送 |
| 后端 | Python sidecar（FastAPI + Uvicorn） | 任务调度与转换执行 |
| 引擎 | PyAV / Pillow / WeasyPrint | 音视频 / 图片 / 文档转换 |
...
- 系统要求：**Windows 10 及以上 / （Debian）,Ubuntu 22.04 及以上（x86_64）**
